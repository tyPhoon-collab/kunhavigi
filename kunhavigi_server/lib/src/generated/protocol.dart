...
import 'features/browse/searched_response.dart' as _i8;
import 'features/future_call/downloaded_file.dart' as _i9;
import 'features/transfer/file_already_exists_exception.dart' as _i10;
import 'features/transfer/upload_progress.dart' as _i11;
import 'package:kunhavigi_shared/kunhavigi_shared.dart' as _i12;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i8.SearchedResponse) {
      return _i8.SearchedResponse.fromJson(data) as T;
    }
    if (t == _i9.DownloadedFile) {
      return _i9.DownloadedFile.fromJson(data) as T;
    }
    if (t == _i10.FileAlreadyExistsException) {
      return _i10.FileAlreadyExistsException.fromJson(data) as T;
    }
    if (t == _i11.UploadProgress) {
      return _i11.UploadProgress.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i8.SearchedResponse?>()) {
      return (data != null ? _i8.SearchedResponse.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i9.DownloadedFile?>()) {
      return (data != null ? _i9.DownloadedFile.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i10.FileAlreadyExistsException?>()) {
      return (data != null
          ? _i10.FileAlreadyExistsException.fromJson(data)
          : null) as T;
    }
    if (t == _i1.getType<_i11.UploadProgress?>()) {
      return (data != null ? _i11.UploadProgress.fromJson(data) : null) as T;
    }
    if (t == List<_i12.Entry>) {
      return (data as List).map((e) => deserialize<_i12.Entry>(e)).toList()
          as T;
    }
    if (t == _i12.Entry) {
      return _i12.Entry.fromJson(data) as T;
    }
    if (t == _i12.FileEntry) {
      return _i12.FileEntry.fromJson(data) as T;
    }
    if (t == _i12.EntryPreview) {
      return _i12.EntryPreview.fromJson(data) as T;
    }
    if (t == _i12.DownloadProgress) {
      return _i12.DownloadProgress.fromJson(data) as T;
    }
    if (t == _i12.SearchQuery) {
      return _i12.SearchQuery.fromJson(data) as T;
    }
    if (t == _i1.getType<_i12.Entry?>()) {
      return (data != null ? _i12.Entry.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i12.FileEntry?>()) {
      return (data != null ? _i12.FileEntry.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i12.EntryPreview?>()) {
      return (data != null ? _i12.EntryPreview.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i12.DownloadProgress?>()) {
      return (data != null ? _i12.DownloadProgress.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i12.SearchQuery?>()) {
      return (data != null ? _i12.SearchQuery.fromJson(data) : null) as T;
    }
    try {
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is _i12.Entry) {
      return 'Entry';
    }
    if (data is _i12.FileEntry) {
      return 'FileEntry';
    }
    if (data is _i12.EntryPreview) {
      return 'EntryPreview';
    }
    if (data is _i12.DownloadProgress) {
      return 'DownloadProgress';
    }
    if (data is _i12.SearchQuery) {
      return 'SearchQuery';
    }
    ...
    if (data is _i8.SearchedResponse) {
      return 'SearchedResponse';
    }
    if (data is _i9.DownloadedFile) {
      return 'DownloadedFile';
    }
    if (data is _i10.FileAlreadyExistsException) {
      return 'FileAlreadyExistsException';
    }
    if (data is _i11.UploadProgress) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'Entry') {
      return deserialize<_i12.Entry>(data['data']);
    }
    if (dataClassName == 'FileEntry') {
      return deserialize<_i12.FileEntry>(data['data']);
    }
    if (dataClassName == 'EntryPreview') {
      return deserialize<_i12.EntryPreview>(data['data']);
    }
    if (dataClassName == 'DownloadProgress') {
      return deserialize<_i12.DownloadProgress>(data['data']);
    }
    if (dataClassName == 'SearchQuery') {
      return deserialize<_i12.SearchQuery>(data['data']);
    }
    ...
    if (dataClassName == 'SearchedResponse') {
      return deserialize<_i8.SearchedResponse>(data['data']);
    }
    if (dataClassName == 'DownloadedFile') {
      return deserialize<_i9.DownloadedFile>(data['data']);
    }
    if (dataClassName == 'FileAlreadyExistsException') {
      return deserialize<_i10.FileAlreadyExistsException>(data['data']);
    }
    if (dataClassName == 'UploadProgress') {
      return deserialize<_i11.UploadProgress>(data['data']);
    }
