...
import 'package:kunhavigi_client/src/protocol/features/browse/searched_response.dart'
    as _i3;
...
class EndpointBrowse extends _i1.EndpointRef {
  ...
  _i2.Stream<_i3.SearchedResponse> searchEntries(
    _i4.SearchQuery query,
    _i2.Stream<int> takes,
  ) =>
      caller.callStreamingServerEndpoint<_i2.Stream<_i3.SearchedResponse>,
          _i3.SearchedResponse>(
        'browse',
        'searchEntries',
        {'query': query},
        {'takes': takes},
  ...
  _i2.Future<_i5.EntriesResponse> getEntries(_i6.RelativePath path) =>
      caller.callServerEndpoint<_i5.EntriesResponse>(
        'browse',
        'getEntries',
        {'path': path},
      );
  ...
  _i2.Future<bool> delete(_i6.RelativePath path) =>
  ...
  _i2.Future<_i6.Entry> rename({
    required _i6.RelativePath path,
    required String newName,
  }) =>
      caller.callServerEndpoint<_i6.Entry>(
        'browse',
        'rename',
        {
          'path': path,
...
class EndpointTransfer extends _i1.EndpointRef {
  ...
  _i2.Future<_i7.EntryPreview> peekEntry(_i6.RelativePath path) =>
      caller.callServerEndpoint<_i7.EntryPreview>(
        'transfer',
        'peekEntry',
        {'path': path},
      );
  ...
  _i2.Stream<_i8.ByteData> downloadFile(_i6.RelativePath path) => caller
          .callStreamingServerEndpoint<_i2.Stream<_i8.ByteData>, _i8.ByteData>(
        'transfer',
        'downloadFile',
        {'path': path},
        {},
  ...
  _i2.Stream<_i9.DownloadProgress> getDownloadUrl(_i6.RelativePath path) =>
      caller.callStreamingServerEndpoint<_i2.Stream<_i9.DownloadProgress>,
  ...
  _i2.Stream<_i10.UploadProgress> uploadFile({
    required _i6.RelativePath path,
    required _i2.Stream<_i8.ByteData> data,
  }) =>
      caller.callStreamingServerEndpoint<_i2.Stream<_i10.UploadProgress>,
          _i10.UploadProgress>(
        'transfer',
        'uploadFile',
        {'path': path},
